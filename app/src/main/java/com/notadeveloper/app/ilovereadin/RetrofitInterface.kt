...
interface RetrofitInterface {
  @FormUrlEncoded
  @POST("api")
  fun authUser(@Field("user") user: String, @Field("pass") pass: String,
      @Field("type") type: String = "get_memid",
      @Field("public_key") public_key: String = "qX6kXT15Iq",
      @Field("hash") hash: String = "4bd1af700fcc6d2dde5e6ab13133fc568d9b7644"): Observable<Result>
